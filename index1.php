				...
				<div class="row justify-content-center">
						...
						<figure class="producto">
							...
							<figcaption class="overlay">
								<p class="overlay-texto"><br><center>Mesa para <br>TV Extensible de 50"<br>
									<h1>Envió Gratis</h1>precio: $1'200.000<br></center></p>
							</figcaption>
							</figure>
					...
					<article class="col-6 col-lg-3 py-1">
						<figure class="producto">
							...
							<figcaption class="overlay">
								<p class="overlay-texto"><br><center>Mesa para <br>TV Extensible de 50"<br>
									<h1>Envió Gratis</h1>precio: $1'300.000<br></center></p>
							</figcaption>
						</figure>
											</article>
					...
					<article class="col-6 col-lg-3 py-1">
						<figure class="producto">
							...
							<figcaption class="overlay">
								<p class="overlay-texto"><br><center>Mesa para <br>TV Extensible de 50"<br>
									<h1>Envió Gratis</h1>precio: $1'400.000<br></center></p>
							</figcaption>
						</figure>
											</article>
					...
					<article class="col-6 col-lg-3 py-1">
						<figure class="producto">
							...
							<figcaption class="overlay">
								<p class="overlay-texto"><br><center>Mesa para <br>TV Extensible de 50"<br>
									<h1>Envió Gratis</h1>precio: $1'350.000<br></center></p>
							</figcaption>
						</figure>
										</article>

					<a href="productos.php">Todos los productos</a></li> 
				</div>
			</div>
		</div>
	</main>
